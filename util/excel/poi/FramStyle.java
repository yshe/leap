...
public class FramStyle {
	...
	public boolean CreateExcelFile(String filePath, String fileName) {
		...
		try {
			...
			cellStyle.setRightBorderColor(HSSFColor.SKY_BLUE.index);// 设置单元格右侧边框边框颜色

			cellStyle.setBottomBorderColor(HSSFColor.SKY_BLUE.index);// 设置单元格底部边框颜色

			cellStyle.setTopBorderColor(HSSFColor.SKY_BLUE.index);// 设置单元部顶部边框颜色
