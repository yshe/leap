...
public class JpegTool { 
        ...
        */ 
        public void doFinal(String pic_big_pathfilename,String pic_small_pathfilename) throws JpegToolException { 
                ...
                System.out.println(this.pic_big_height+"原图像的高度");
                System.out.println(this.pic_big_height+"原图像的宽度");
                ...
                System.out.println(smallw+"缩小后的宽度");
                System.out.println(smallh+"缩小后的高度");
